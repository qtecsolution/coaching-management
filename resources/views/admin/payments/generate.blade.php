        ...
        <div class="card">
            <div class="card-body">
                <div class="alert alert-light-info color-info">
                    ...
                    </svg> Tuition fee for all active batches are automatically generated each month using a scheduler. However, in case the scheduler fails to run for any reason, you can use the form below to manually generate tuition fee for any specific month. You can see generated payments in 'Payment Due'.  
                </div>
