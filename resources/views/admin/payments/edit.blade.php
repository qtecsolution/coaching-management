                ...
                <div class="card-body">
                    <form action="{{ route('admin.payments.update', $payment->id) }}" method="POST">
                                    ...
                                    <select name="batch" class="form-control select2" id="batch">
                                        ...
                                        @foreach ($batches as $batch)
                                            <option value="{{ $batch->id }}"
                                                {{ old('batch', $payment->batch_id) == $batch->id ? 'selected' : '' }}>{{ $batch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Name"
                                        class="form-control" value="{{ old('name', $payment->user->name) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="phone" id="phone" placeholder="Phone"
                                        class="form-control" value="{{ old('phone', $payment->user->phone) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="Email"
                                        class="form-control" value="{{ old('email', $payment->user->email) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="school_name" id="school" placeholder="School Name"
                                        class="form-control" value="{{ old('school_name', $payment->school_name) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="class" id="class" placeholder="Class"
                                        class="form-control" value="{{ old('class', $payment->class) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date_of_birth" id="date_of_birth"
                                        ...
                                        value="{{ old('date_of_birth', $payment->date_of_birth) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="father_name" id="father_name" placeholder="Father Name"
                                        class="form-control" value="{{ old('father_name', $payment->father_name) }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mother_name" id="mother_name" placeholder="Mother Name"
                                        class="form-control" value="{{ old('mother_name', $payment->mother_name) }}"
                                        required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="address" class="form-label">Address<sup
                                            class="text-danger">*</sup></label>
                                    <textarea name="address" id="address" rows="5" class="form-control" placeholder="Address" required>{{ old('address', $payment->address) }}</textarea>
                            ...
                            @php
                                $emergency_contact = json_decode($payment->emergency_contact, true);
                            @endphp
