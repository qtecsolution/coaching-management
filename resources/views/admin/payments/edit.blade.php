                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="batch_id" id="batch_id"
                                        value="{{ $payment->student_batch->batch->id }}" readonly>
                                    <input type="text" class="form-control" name="batch_name" id="batch_name"
                                        value="{{ $payment->student_batch->batch->name }}" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="student_batch_id" id="student_batch_id"
                                        value="{{ $payment->student_batch->id }}" readonly>
                                    <input type="text" class="form-control" name="name" id="name"
                                        value="{{ $payment->student_batch->student->name }}" readonly>
                                    {{-- <select name="student_batch_id" class="form-control select2"
                                        id="student_batch_id" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" readonly name="amount" id="amount" placeholder="amount"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="month" id="month" placeholder="Enter Month"
                                        class="form-control" value="{{ old('month', $payment->month) }}" required readonly>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" id="date"
                                            class="form-control flatpickr-date" value="{{ old('date', $payment->date) }}">
